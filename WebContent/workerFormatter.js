...
function valueToHTML(value) {
	var valueType = typeof value, output = "", asDate = isDate(value);
	if (value == null)
	...
	if ( asDate ){
		output +=  ' <span class="type-date"> [<b>' + asDate.toLocaleString() + '</b>] </span>';
	}
	return output;
}
...
function keyToHTML(value) {
	...
	if (asDate) {
		output += ' <span class="type-date"> [<b>' + asDate.toLocaleString()
				+ '</b>] </span>';
	}
	return output;
}
